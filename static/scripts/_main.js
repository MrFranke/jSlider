 ...
 *          });
 */
define('js-error-log/log',[],function() {
 ...
 */
define('js-error-log/main',[ './log' ], function( log ) {
    var LIMIT            = 5
      , counter          = 0
...
define('js-error-log', ['js-error-log/main'], function (main) { return main; });
...
define("console-log/main", function(){});
...
define('Modernizr/main',[],function() {
...
define('Modernizr', ['Modernizr/main'], function (main) { return main; });
...
define('jslider/jquery.jslider',[ 'jquery' ], function( jQuery ) {
...
define('jslider', ['jslider/jquery.jslider'], function (main) { return main; });

define('colorbox/jquery.colorbox',[ 'jquery' ], function( jQuery ) {
...
define('colorbox', ['colorbox/jquery.colorbox'], function (main) { return main; });

define('pages/index/main',[
      'jquery'
